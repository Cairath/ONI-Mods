...
namespace FlowSplitters
{
	public class GasSplitterConfig : IBuildingConfig
	{
		...
		public const string DisplayName = "Gas Splitter";
		public const string Description = "Splits gases equally in two pipes. If one the output pipes can't handle half of the input, the other pipe will receive it.";
		public const string Effect = "Have you ever wanted to have your gases in two places at once?";

		private readonly ConduitPortInfo _secondaryPort = new ConduitPortInfo(ConduitType.Gas, new CellOffset(1, 1));
