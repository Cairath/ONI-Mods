...
{
	public class LiquidSplitterBConfig : IBuildingConfig
	{
		public const string Id = "LiquidSplitterB";
		public const string DisplayName = "Liquid Splitter B";
		public const string Description = "Have you ever wanted to have your liquids in two places at once?";
		public const string Effect = "Splits liquids equally in two pipes. If one the output pipes can't handle half of the input, the other pipe will receive it.";

		private readonly ConduitPortInfo _secondaryPort = new ConduitPortInfo(ConduitType.Liquid, new CellOffset(0, 1));
