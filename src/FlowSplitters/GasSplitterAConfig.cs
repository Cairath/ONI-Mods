...
{
	public class GasSplitterAConfig : IBuildingConfig
	{
		public const string Id = "GasSplitterA";
		public const string DisplayName = "Gas Splitter A";
