...
namespace ConveyorRailFilter.Filter
{
	public class ConveyorFilterConfig : IBuildingConfig
	{
		...
		public const string Description = "Filters incoming items on the Conveyor Rail. Filtered items (selected on the list) are put on the secondary output.";
