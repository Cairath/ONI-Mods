...
{
	public class BlueprintDisplayBConfig : IBuildingConfig
	{
		public const string Id = "BlueprintDisplayB";
		public const string DisplayName = "Blueprint Display B";
