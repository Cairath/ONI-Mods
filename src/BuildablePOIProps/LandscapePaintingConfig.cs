...
{
	public class LandscapePaintingConfig : IBuildingConfig
	{
		public const string Id = "LandscapePainting";
		public const string DisplayName = "Landscape Painting";
		public const string Description = "Signed by: Dupe Ross";
