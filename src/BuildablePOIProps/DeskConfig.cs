...
{
	public class DeskConfig : IBuildingConfig
	{
		public const string Id = "Desk";
		public const string DisplayName = "Desk";
		public const string Description = "Does it belong to someone important?";
