...
{
	public class BlueprintDisplayCConfig : IBuildingConfig
	{
		public const string Id = "BlueprintDisplayC";
		public const string DisplayName = "Blueprint Display C";
