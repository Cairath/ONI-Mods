...
{
	public class GlobeConfig : IBuildingConfig
	{
		public const string Id = "Globe";
		public const string DisplayName = "Globe";
		public const string Description = "Memories of home.";
